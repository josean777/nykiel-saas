  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#F5F5DC" }}>
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur border-b" style={{ borderColor: "#E8E8D0" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            <Button 
              ...
              className="border-gray-300 text-gray-700 hover:bg-gray-50 text-sm h-9 px-6"
            >
              Cadastro
            </Button>
            <Button 
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t" style={{ borderColor: "#E8E8D0" }}>
            <div className="px-4 py-4 space-y-3">
              <a 
                href="#especialidades" 
                onClick={() => setMobileMenuOpen(false)}
                className="block text-sm text-gray-700 hover:text-gray-900 py-2 transition"
              >
                Especialidades
              </a>
              <button 
                onClick={() => handleNavClick("/team")}
                className="block w-full text-left text-sm text-gray-700 hover:text-gray-900 py-2 transition"
              >
                Equipe
              </button>
              <a 
              ...
              <div className="pt-3 border-t" style={{ borderColor: "#E8E8D0" }}>
                <Button 
                  variant="outline" 
                  onClick={() => handleNavClick("/register")} 
                  className="w-full border-gray-300 text-gray-700 hover:bg-gray-50 text-sm h-9 mb-2"
                >
                  Cadastro
                </Button>
                <Button 
                  onClick={() => handleNavClick("/login")} 
                  className="w-full text-white text-sm h-9 font-medium"
                  style={{ backgroundColor: "#D4A574" }}
                >
                  Entrar
                </Button>
      ...
      {/* Hero */}
      <section className="py-16 md:py-32 px-4" style={{ backgroundColor: "#F5F5DC" }}>
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div>
              ...
              <p className="text-base md:text-lg text-gray-700 mb-6 md:mb-8 leading-relaxed max-w-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
                <Button 
                  ...
                  className="text-white font-semibold px-6 md:px-8 py-2 md:py-3 rounded-lg h-auto text-sm md:text-base"
                  style={{ backgroundColor: "#D4A574" }}
                >
                  Agendar Consulta
                ...
                <Button 
                  size="lg" 
                  variant="outline"
                  className="border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold px-6 md:px-8 py-2 md:py-3 rounded-lg h-auto text-sm md:text-base"
                >
                  Saiba Mais
                </Button>
              </div>
      ...
      {/* Especialidades */}
      <section id="especialidades" className="py-16 md:py-32 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
              ...
              return (
                ...
                >
                  <CardContent className="p-6 md:p-8">
                    ...
                    <h3 className="text-base md:text-lg font-semibold text-gray-900 mb-2">{specialty.title}</h3>
      ...
      {/* Contato */}
      <section id="contato" className="py-16 md:py-32 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-3 md:mb-4">
              Entre em Contato
              ...
              return (
                <Card key={idx} className="bg-white border border-gray-200 rounded-xl">
                  <CardContent className="p-6 md:p-8 text-center">
                    ...
                    <p className="text-gray-700 font-medium text-sm md:text-base">{item.content}</p>
                  </CardContent>
                </Card>
              );
            })}
          ...
          <div className="flex justify-center">
            <Button
              size="lg"
              className="text-white font-semibold px-6 md:px-10 py-2 md:py-3 rounded-lg h-auto text-sm md:text-base"
      ...
      {/* Footer */}
      <footer className="bg-gray-900 text-gray-400 py-8 md:py-12 px-4 border-t" style={{ borderColor: "#3F3F3F" }}>
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mb-6 md:mb-8">
            <div>
              <div className="flex items-center gap-2 mb-3 md:mb-4">
                ...
                <span className="font-semibold text-white text-sm md:text-base">Nykiel</span>
              </div>
              <p className="text-xs md:text-sm text-gray-500">Saúde integrada, cuidado completo</p>
            </div>
            <div>
              <p className="font-semibold text-white mb-3 text-xs md:text-sm">SERVIÇOS</p>
            ...
            <div>
              <p className="font-semibold text-white mb-3 text-xs md:text-sm">LEGAL</p>
              <ul className="space-y-2 text-xs md:text-sm">
            ...
            <div>
              <p className="font-semibold text-white mb-3 text-xs md:text-sm">REDES SOCIAIS</p>
